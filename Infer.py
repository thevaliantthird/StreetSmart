...
class Infer:
    ...
    def __init__(self, RectL, IMGDIM):
        ...
        self.ReduceNoise()
        with open('TrafficH.npy','wb') as f:
            np.save(f,self.TrafficMapH)
        with open('TrafficV.npy','wb') as f:
            np.save(f,self.TrafficMapV)
        with open('Traffic.npy','wb') as f:
            np.save(f,self.TrafficMap)
        self.DirectTraffic()
    ...
    def DirectTraffic(self, threshold):
